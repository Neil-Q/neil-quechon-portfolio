<template>
    <div class="project_presentation">
        ...
        <div class="illustration">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="2 4 20 16" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="presentation shadow_boxed_light">
            ...
            <div class="links_container">
                ...
                <a v-if="gitRepoLink" class="git_link" href="#">
...
<style lang="scss" scoped>
    ...
    .presentation {
        ...
        margin: auto;
        padding: 1.5em;
        border-top: 0.5em var(--primary-color) solid;
    }
